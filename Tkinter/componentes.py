...
class ComponentesVentana(tk.Tk):
    def __init__(self) -> None:
        super().__init__()
        self.geometry('600x400+1500+200')
    ...
    def _crear_componentes_tabulador4(self, tabulador):
        ...
        def mostrar_titulo():
            messagebox.showinfo('Más info imagen', f'Nombre de la imagen: {imagen.cget("file")}')
        boton_imagen = ttk.Button(tabulador, image=imagen, command=mostrar_titulo)
        boton_imagen.grid(column=0, row=0)
    ...
    def _crear_componentes_tabulador5(self, tabulador):
        ...
        barra_progreso.grid(column=0, row=0, padx=10, pady=10, columnspan=4)
