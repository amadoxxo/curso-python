...
# Recuperar el valor indicando una llave
print(diccionario['Nombre'])
# Si no se encuentra la llave lanza una excepción
# print(diccionario['nombre'])

# Método get recupera una llave, y si no existe NO lanza una excepción
# además podemos regresar un valor en caso de que no exista la llave
print(diccionario.get('Nombres', 'No se encontró la llave'))
print(diccionario)

# setdefault si modifica el diccionario, además se agrega un valor por default
